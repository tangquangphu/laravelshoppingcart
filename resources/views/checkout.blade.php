...
@section('content')
    ...
    <div class="container">
        @if (session()->has('success_message'))
            ...
            <div class="alert alert-success_message">
                ...
                <form action="{{ route('checkout.store') }}" method="POST" id="payment-form">
                    ...
                    <div class="half-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="province" name="province" value="{{ old('provine') }}" required>
                        </div>
                    </div> <!-- end half-form -->
...
@section('extra-js')
    <script>
        (function () {
            ...
            var stripe = Stripe('pk_test_xOeLA6hF812uNCUPYrfwnhWf');
